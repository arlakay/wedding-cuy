...
const CountdownTimer = () => {
    ...
    useEffect(() => {
        const x = setInterval(function () {
            const countDownDate = new Date('Oct 06, 2024 11:00:00').getTime();
    ...
    return (
        <div className="mt-8 mb-8 pt-8 pb-8 w-full max-w-md md:mx-auto my-10 px-4 md:px-10 flex flex-col items-center justify-center shadow-2xl rounded-lg bg-white text-black text-center bg-no-repeat bg-center bg-cover">
